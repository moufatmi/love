        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h3 className="text-3xl font-serif font-bold">Emma & James</h3>
              <Heart className="w-8 h-8 text-rose-400 fill-current" />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-300">emma.james.love@example.com</span>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-gray-400 text-sm">
                © 2024 Emma & James. Made with love and endless cups of coffee.
              </p>
